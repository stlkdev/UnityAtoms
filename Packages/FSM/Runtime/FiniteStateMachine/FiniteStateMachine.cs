...
namespace UnityAtoms.FSM
{
    ...
    public class FiniteStateMachine : StringVariable
    {
        ...
        private void OnEnable()
        {
            ...
            _currentFlatValue = InitialValue;
        ...
        public void Dispatch(StringConstant command)
        {
        ...
        public void Dispatch(string command)
        {
            ...
            else
            {
                ...
                if (state == null || state.SubMachine == null)
                {
                    Debug.LogError($"Unexpected transition for command {command} on state {Value} on FSM {name}");
                }
                else
                {
