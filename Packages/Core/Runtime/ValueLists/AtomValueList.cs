...
namespace UnityAtoms
{
        ...
        where E : AtomEvent<T>
    {
        ...
        /// </summary>
        static public Func<BaseAtomValueList, List<T>> _loadFunc;

        [SerializeField]
        protected LoaderType _useLoader = LoaderType.Undefined;

        [SerializeField]
        public bool addToResetList = true;
        static public Action<BaseAtomValueList> _addToResetListFunc;
