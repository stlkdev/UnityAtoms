        ...
        where VI : AtomVariableInstancer<V, P, T, E1, E2, F>
    {
        ...
        public T InitialValue
        {
            get
            {
                ...
                {
                    case (AtomReferenceUsage.CONSTANT): return _constant == null ? default(T) : _constant.Value;
                    case (AtomReferenceUsage.VARIABLE): return _variable == null ? default(T) : _variable.InitialValue;
                    case (AtomReferenceUsage.VARIABLE_INSTANCER): return _variableInstancer == null || _variableInstancer.Variable == null ? default(T) : _variableInstancer.Variable.InitialValue;
                    case (AtomReferenceUsage.VALUE):
                    default:
                        return _value;
                }
        ...
        public string Id
        {
            get
            {
                switch (_usage)
                {
                    case (AtomReferenceUsage.CONSTANT): return _constant == null ? "" : _constant.Id;
                    case (AtomReferenceUsage.VARIABLE): return _variable == null ? "" : _variable.Id;
                    case (AtomReferenceUsage.VARIABLE_INSTANCER): return _variableInstancer == null || _variableInstancer.Variable == null ? "" : "Instancer ID TODO";
                    case (AtomReferenceUsage.VALUE):
                    default:
                        return "";
                }
        ...
        /// <returns>True if the `Usage` is an AtomType and is assigned. False otherwise.</returns>
        ...
        /// <returns>True if the `Usage` is an AtomType and is assigned other then `CONSTANT`. False otherwise.</returns>
        public bool IsAssignedVariable
        {
            get
            {
                switch (_usage)
                {
                    case (AtomReferenceUsage.CONSTANT): return false;
                    case (AtomReferenceUsage.VARIABLE): return _variable != null;
                    case (AtomReferenceUsage.VARIABLE_INSTANCER): return _variableInstancer != null && _variableInstancer.Variable != null;
                }
                return true;
        ...
        public void Unassign()
        {
            switch (_usage)
            {
                case (AtomReferenceUsage.CONSTANT): _constant = null; break;
                case (AtomReferenceUsage.VARIABLE): _variable = null; break;
                case (AtomReferenceUsage.VARIABLE_INSTANCER): _variableInstancer = null; break;
            }
        }
        ...
        protected AtomReference(C constant) : this()
        {
            _usage = AtomReferenceUsage.CONSTANT;
            _constant = constant;
        }


        protected AtomReference(V variable) : this()
        {
            _usage = AtomReferenceUsage.VARIABLE;
            _variable = variable;
        }
